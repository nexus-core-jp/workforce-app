...
| ロール | 月額(税抜) | 含まれる機能 |
|--------|-----------|-------------|
| **管理者 (ADMIN)** | **700円/人** | 全機能: 勤怠・給与計算・freee/MF連携・労務ダッシュボード・承認/締め・メンバー管理 |
| **従業員 (EMPLOYEE)** | **500円/人** | 打刻・日報・有給申請・勤怠履歴・LINE打刻・顔認証 |

- **30日間無料トライアル** (全機能利用可)
- トライアル終了後、Stripe / PAY.JP で決済開始
- 月額最低利用料なし
...
| 会社規模 | 月額合計 | 1人あたり |
|----------|----------|-----------|
| 5人 (ADMIN 1 + 従業員 4) | 2,700円 | 540円 |
| 10人 (ADMIN 1 + 従業員 9) | 5,200円 | 520円 |
| 30人 (ADMIN 2 + 従業員 28) | 15,400円 | 513円 |
| 50人 (ADMIN 3 + 従業員 47) | 25,600円 | 512円 |
...
2. ダッシュボード → **Products** → 商品を2つ作成:
   - "Workforce Nexus ADMIN" — 月額 ¥700/人
   - "Workforce Nexus EMPLOYEE" — 月額 ¥500/人
3. 各価格の `price_xxxx` を控える
