...
export function FaceAuthToggle({ available, enabled, kioskUrl, registeredUsers, totalUsers }: { available: boolean; enabled: boolean; kioskUrl: string; registeredUsers: number; totalUsers: number }) {
